...
<div class="p-6 sm:p-10 font-sans">
    ...
    <div id="viewKelas" class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        <div class="overflow-x-auto">
            <table class="w-full text-left border-collapse">
                <thead>
                    <tr class="bg-emerald-50/70 border-b border-emerald-100 text-sm font-semibold text-emerald-900">
                ...
                <tbody class="divide-y divide-gray-100 text-sm text-gray-700">
                    ...
                    <tr onclick="showStudents('XI RPL 1')" class="hover:bg-emerald-50/30 cursor-pointer transition">
                        ...
                        <td class="p-4 text-center space-x-2">
                            ...
                            <button onclick="event.stopPropagation();" class="text-gray-400 hover:text-amber-600 transition" title="Edit">
    ...
    <div id="viewSiswa" class="hidden">
        ...
        <div class="mb-6">
            <button onclick="hideStudents()" class="mb-2 text-emerald-600 hover:text-emerald-700 flex items-center gap-1 text-sm font-medium transition">
        ...
        <!-- Form Tambah Siswa (Di dalam View Siswa) -->
        <div class="bg-white rounded-xl shadow-sm border border-emerald-100 p-6 mb-6">
            ...
            <form action="#" method="POST" class="flex flex-col md:flex-row gap-4 items-end">
                @csrf
                <input type="hidden" name="kelas" id="inputKelasHidden"> <!-- Value diisi oleh JS -->
                
                <div class="flex-1 w-full">
                    <label class="block text-sm font-medium text-gray-700 mb-1">Nama Lengkap</label>
                    <input type="text" name="nama_siswa" placeholder="Masukkan nama siswa..." class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 text-sm">
                </div>
                <div class="flex-1 w-full">
                    <label class="block text-sm font-medium text-gray-700 mb-1">NIS</label>
                    <input type="text" name="nis" placeholder="Cth: 10021" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 text-sm">
                </div>
                <button type="submit" class="w-full md:w-auto px-6 py-2.5 bg-emerald-600 hover:bg-emerald-700 text-white rounded-lg transition shadow-sm text-sm font-medium">
                    Simpan Siswa
                </button>
            </form>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            <div class="bg-gray-50/50 p-4 border-b border-gray-100 flex justify-between items-center">
                ...
                <div class="relative">
                    ...
                    <input type="text" placeholder="Cari siswa..." class="pl-9 pr-3 py-1.5 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 outline-none w-64">
                </div>
            </div>
            <table class="w-full text-left border-collapse">
                <thead>
