        ...
        <div class="mx-auto max-w-7xl">
            ...
            <section class="mb-6 rounded-2xl border border-slate-200 bg-white p-4 shadow-sm sm:p-5" aria-label="Pencarian dan filter kehadiran">
                <div class="flex flex-col gap-3 md:flex-row">
                    <label class="relative flex-1"><span class="sr-only">Cari nama atau NIP</span><i class="bi bi-search pointer-events-none absolute left-3 top-1/2 -translate-y-1/2 text-slate-400" aria-hidden="true"></i><input id="teacher-search" type="search" placeholder="Cari nama atau NIP guru..." autocomplete="off" class="w-full rounded-xl border border-slate-300 bg-white py-3 pl-10 pr-4 text-sm text-slate-700 outline-none transition placeholder:text-slate-400 focus:border-emerald-500 focus:ring-4 focus:ring-emerald-100"></label>
